...
#  python .\od_image_count.py -m .\Tensorflow\pre_trained_model\ssd_mobilenet_v2_fpnlite_320x320_coco17_tpu-8\saved_model -l .\Tensorflow\models\research\object_detection\data\mscoco_label_map.pbtxt -i .\Input